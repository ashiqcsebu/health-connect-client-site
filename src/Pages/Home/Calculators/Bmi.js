    ...
    <div className="border p-24">
      ...
      <div className="w-full m-auto h-60 ">
        ...
        <div className=" flex items-center my-3 ">
          <input
            type="number"
            className="border w-1/2 mr-2 appearance-none outline-none"
          ...
          <input
            type="number"
            className="border w-1/2 appearance-none outline-none"
            style={{ WebkitAppearance: "none" }}
        ...
        />
        <button
          className="bg-gradient-to-r from-blue-400 to-blue-800 text-gray-100 font-semibold text-md px-5 py-1 rounded my-3 hover:from-blue-500 hover:to-blue-800 hover:bg-gradient-to-r"
          ...
          <div className="text-center ">
            ...
            {BMI > 25 ? (
              ...
              <span className="text-sm font-semibold text-green-500">
                Congratulations You are in Perfect Shape{" "}
              </span>
            ) : (
              <span className="text-sm font-semibold text-red-400">
                Oops Your're underweight
              </span>
            )}
